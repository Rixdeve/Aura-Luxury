            ...
            <div
                ...
                <div class="p-3">
                    ...
                    <div class="pt-1 text-right">
                        <p class="text-sm font-light capitalize">Total Orders</p>
                        <h4 class="text-2xl font-semibold tracking-tighter xl:text-2xl">{{ $totalOrders }}</h4>
                    </div>
                </div>
                <hr class="opacity-50" />
            </div>
            ...
            <div
                ...
                <div class="p-3">
                    ...
                    <div class="pt-1 text-right">
                        ...
                        <h4 class="text-2xl font-semibold tracking-tighter xl:text-2xl"> {{ $totalUsers }}
                        </h4>
                    </div>
                </div>
                <hr class="opacity-50" />
            ...
            <div
                ...
                <div class="p-3">
                    ...
                    <div class="pt-1 text-right">
                        ...
                        <h4 class="text-2xl font-semibold tracking-tighter xl:text-2xl"> Rs.
