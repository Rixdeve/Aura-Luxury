<div>
    <nav class="bg-black h-screen fixed top-0 left-0 min-w-[260px] py-6 px-4 flex flex-col overflow-auto">
        <div class="flex flex-wrap flex-col justify-center items-center cursor-pointer">
            <div
                class="bg-gray-300 w-12 h-12 rounded-full flex items-center justify-center font-bold text-black text-xl">
                <span>S</span>
            </div>

            <div class="text-center mt-4">
                <p class="text-[15px] text-white font-medium">John Doe</p>
        ...
        <ul class="space-y-3 mt-8">
            <li>
                <a href="javascript:void(0)"
                    class="text-gray-300 hover:text-white text-[15px] font-normal flex items-center hover:bg-gray-900 rounded px-4 py-2 transition-all">
